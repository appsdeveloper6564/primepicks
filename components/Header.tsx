      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 lg:gap-8 w-full md:w-auto justify-between md:justify-start">
            ...
            {/* Navigation */}
            <nav className="flex items-center bg-slate-100 p-1 rounded-lg overflow-x-auto no-scrollbar">
              <button 
                onClick={() => setActiveView('home')}
                className={`px-3 lg:px-4 py-2 text-sm font-medium rounded-md transition-all whitespace-nowrap ${
                  activeView === 'home' 
              ...
              <button 
                ...
                className={`px-3 lg:px-4 py-2 text-sm font-medium rounded-md transition-all flex items-center whitespace-nowrap ${
                  activeView === 'scout' 
